...
//volatile unsigned int vlen;//=len;
void enc_read_buf( unsigned char *buf, unsigned int len )
{
	unsigned int vlen;
	//static volatile refcnt=0;
...
unsigned int enc_receive_packet( unsigned int bufsize, unsigned char *buf )
{
	...
	volatile unsigned int len, status;
	unsigned char u;
