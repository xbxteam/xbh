...
Addons :  USE_LCD_4Bit wird zur Ansteuerung f�r Paraell Ansteuerung benutzt (Ralf Figge)
...
#include <config.h>
	...
	extern void lcd_vprint_P (unsigned char,unsigned char,const char *Buffer, va_list *ap);
	...
	#define LCD_RS					4 		//Pin f�r RS
	#define LCD_RW					5		//Pin f�r Read/Write
	#define LCD_E					6 		//Pin f�r Enable
